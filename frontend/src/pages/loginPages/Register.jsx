...
const RegistrationPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(REGISTER_ROUTE, formData, { withCredentials: true });
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col">
                        ...
                        >
                            ...
                            <option value="Chief Warden">ChiefWarden</option>
                    ...
                    {error === '' && (
                            ...
                            <button type="submit" className="w-full bg-indigo-600 text-white font-semibold py-3 rounded-lg hover:bg-indigo-700 transition duration-300">
                                Register f
                            </button>
                            </div>
                    )}
